![logo](https://raw.githubusercontent.com/causenet/trojan-gfw-script/master/logo.png)
# VPS Toolbox
...
Then
```
sudo bash -c "$(curl -fsSL https://raw.githubusercontent.com/causenet/trojan-gfw-script/master/vpstoolbox.sh)"
```
![menu](https://raw.githubusercontent.com/causenet/trojan-gfw-script/master/mainmenu.png)
![choose](https://raw.githubusercontent.com/causent/trojan-gfw-script/master/1.png)

Old Version(include V2ray and ss）
```
sudo bash -c "$(curl -fsSL https://raw.githubusercontent.com/causenet/trojan-gfw-script/master/trojangui.sh)"
```
...
![Trojan-GFW QR code](https://raw.githubusercontent.com/causenet/trojan-gfw-script/master/trojanscript.png)
